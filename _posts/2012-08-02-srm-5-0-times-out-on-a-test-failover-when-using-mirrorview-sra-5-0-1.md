...
Following the sequence of events, the first thing we see is the SRA querying the array for it&#8217;s information.
	...
	2012-07-20 12:41:09,106 : MirrorView Enabler Version: 5.0.17  
	2012-07-20 12:41:09,106 : 172.16.0.10 Executing command: arrayname  
	2012-07-20 12:41:10,481 : 172.16.0.10 Command result: stdout(Array Name: CX-SP2), stderr()  
	2012-07-20 12:41:10,481 : Using enabler 'Mirrorview'...  
	2012-07-20 12:41:10,497 : 172.16.0.10 Executing command: getarrayuid  
	2012-07-20 12:41:11,840 : 172.16.0.10 Command result: stdout(Hostname Array UID  
	\---\---\-- -\---\---\---  
	CX-SP2A 50:06:01:60:01:23:45:67), stderr()  
	2012-07-20 12:41:11,840 : 172.16.0.10 Executing command: getagent  
	2012-07-20 12:41:13,200 : 172.16.0.10 Command result: stdout(Agent Rev: 7.30.13 (0.99)  
	Name: K10  
	Desc:  
...
It then goes on to query the first LUN.
	...
	2012-07-20 12:41:16,591 : 172.16.0.10 Executing command: mirror -async -list -name "LUN 10"  
	2012-07-20 12:41:18,637 : 172.16.0.10 Command result: stdout(MirrorView Name: LUN 10  
	...
	2012-07-20 12:41:18,637 : Retrieving information for LUN 10...  
	2012-07-20 12:41:18,637 : 172.16.0.10 Executing command: getlun 10 -name -owner -default -capacity  
	2012-07-20 12:41:20,169 : 172.16.0.10 Command result: stdout(Name LUN 10  
	Current owner: SP B  
	Default Owner: SP A  
	LUN Capacity(Megabytes): 563200  
	LUN Capacity(Blocks): 1153433600), stderr()  
	2012-07-20 12:41:20,169 : Caching LUN 10 with name: LUN 10 
...
List snapshots for the array
	...
	2012-07-20 12:41:20,169 : 172.16.0.10 Executing command: snapview -listsnapshots  
	2012-07-20 12:41:22,231 : 172.16.0.10 Command result: stdout(), stderror()  
	

Since there are no snapshots for this LUN, the SRA creates one.

	  
	2012-07-20 12:41:22,231 : Creating SnapView snapshot with name: async-LUN 10_SRM-TEST-FAILOVER, of LUN: 10  
	2012-07-20 12:41:22,231 : Searching for current SP owner of lun: 10  
	2012-07-20 12:41:22,231 : 172.16.0.11 Executing command: snapview -createsnapshot 10 -snapshotname "async-LUN 10_SRM-TEST-FAILOVER"  
	2012-07-20 12:41:25,153 : 172.16.0.11 Command result: stdout(), stderr()  
	

List the snapshot we just created.

	  
	2012-07-20 12:41:25,153 : Retrieving info for SnapView snapshot with name: async-LUN 10_SRM-TEST-FAILOVER  
	2012-07-20 12:41:25,153 : 172.16.0.11 Executing command: snapview -listsnapshots -snapshotname "async-LUN 10_SRM-TEST-FAILOVER"  
	2012-07-20 12:41:27,388 : 172.16.0.11 Command result: stdout(SnapView logical unit name: async-LUN 10_SRM-TEST-FAILOVER  
...
Start a session for the snapshot LUN and check the session.
	...
	2012-07-20 12:41:27,388 : Starting SnapView session with name: async-LUN 10\_SRM-TEST-FAILOVER\_session, for snapshot: async-LUN 10_SRM-TEST-FAILOVER  
	2012-07-20 12:41:27,388 : 172.16.0.11 Executing command: snapview -startsession "async-LUN 10\_SRM-TEST-FAILOVER\_session" -snapshotname "async-LUN 10_SRM-TEST-FAILOVER" -persistence  
	2012-07-20 12:41:31,450 : 172.16.0.11 Command result: stdout(You must activate a snapshot on this session before you can access it.), stderr()  
	2012-07-20 12:41:31,450 : Retrieving info for SnapView session with name async-LUN 10\_SRM-TEST-FAILOVER\_session  
	2012-07-20 12:41:31,450 : 172.16.0.11 Executing command: snapview -listsessions -name "async-LUN 10\_SRM-TEST-FAILOVER\_session"  
	2012-07-20 12:41:33,654 : 172.16.0.11 Command result: stdout(Name of the session: async-LUN 10\_SRM-TEST-FAILOVER\_session  
...
Activate the snapshot and check
	...
	2012-07-20 12:41:33,654 : Activating SnapView snapshot with name: async-LUN 10\_SRM-TEST-FAILOVER, on session: async-LUN 10\_SRM-TEST-FAILOVER_session  
	2012-07-20 12:41:33,654 : Searching for current SP owner of lun: 10  
	2012-07-20 12:41:33,654 : 172.16.0.11 Executing command: snapview -activatesnapshot "async-LUN 10\_SRM-TEST-FAILOVER\_session" -snapshotname "async-LUN 10_SRM-TEST-FAILOVER"  
	2012-07-20 12:41:35,872 : 172.16.0.11 Command result: stdout(), stderr()  
	2012-07-20 12:41:35,872 : Searching for current SP owner of lun: 10  
	2012-07-20 12:41:35,872 : Retrieving info for SnapView snapshot with name: async-LUN 10_SRM-TEST-FAILOVER  
	2012-07-20 12:41:35,872 : 172.16.0.11 Executing command: snapview -listsnapshots -snapshotname "async-LUN 10_SRM-TEST-FAILOVER"  
	2012-07-20 12:41:38,060 : 172.16.0.11 Command result: stdout(SnapView logical unit name: async-LUN 10_SRM-TEST-FAILOVER  
	SnapView logical unit ID: 60:06:01:60:AB:89:67:56:45:34:23:12:01:AB:CD:EF  
	Target Logical Unit: 10  
	State: Active  
...
So we have the LUN active and ready to be presented to a host. The SRA then needs to add it to a storage group. The CX/VNX should only have a host in a single storage group, so the SRA scans for existsing storage groups with the initiatiors that we need.
	...
	2012-07-20 12:41:40,170 : Retrieving storage group information...  
	2012-07-20 12:41:40,170 : 172.16.0.10 Executing command: storagegroup -list  
	2012-07-20 12:41:41,748 : 172.16.0.10 Command result: stdout(Storage Group Name: ABC SRM  
...
Since the &#8220;ABC SRM&#8221; storage group has all of the initiators, the SRA decides to add the snapshot to this group.
	...
	2012-07-20 12:41:41,748 : Adding snapshot async-LUN 10_SRM-TEST-FAILOVER to storage group ABC SRM with hlu 255  
	2012-07-20 12:41:41,748 : 172.16.0.10 Executing command: storagegroup -addsnapshot -gname "ABC SRM" -snapshotname "async-LUN 10_SRM-TEST-FAILOVER" -hlu 255  
	2012-07-20 12:41:43,904 : 172.16.0.10 Command result: stdout(Error: storagegroup command failed  
...
The operation does not throw anything in stderror, but does not add the LUN to the group because it cannot find the group. The SRA then queries the storage groups again to see if this LUN was added in (hlu 255)
	...
	2012-07-20 12:41:43,904 : Retrieving storage group information...  
	2012-07-20 12:41:43,904 : 172.16.0.10 Executing command: storagegroup -list  
	2012-07-20 12:41:45,435 : 172.16.0.10 Command result: stdout(Storage Group Name: ABC SRM  
	Storage Group UID: DD:CC:BB:AA:00:11:22:33:44:55:66:87:09:AB:DC:FE  
	HBA/SP Pairs:
...
There is no 255 in the HLU output, so the SRA tries to add it again.
	...
	2012-07-20 12:41:45,435 : Adding snapshot async-LUN 10_SRM-TEST-FAILOVER to storage group ABC SRM with hlu 255  
	2012-07-20 12:41:45,435 : 172.16.0.10 Executing command: storagegroup -addsnapshot -gname "ABC SRM" -snapshotname "async-LUN 10_SRM-TEST-FAILOVER" -hlu 255  
	2012-07-20 12:41:47,420 : 172.16.0.10 Command result: stdout(Error: storagegroup command failed  
	The group name entered does not match any storage groups for this array), stderr()  
