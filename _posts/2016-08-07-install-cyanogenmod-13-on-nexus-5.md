...
### Unlock Phone
We can follow the instructions laid out in How to [Install CyanogenMod on the Google Nexus 5 ("hammerhead")](http://www.cyanogenmods.org/nexus-5-cm-13-goes-official-and-here-is-how-to-flash/). First let's boot the phone into the fastboot mode:
