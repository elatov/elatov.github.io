...
Nothing complicated. I did some research and I actually found a very good website which talked about best practices for ZFS, here is a [link](https://googledrive.com/host/0B4vYKT_-8g4IWE9kS2hMMmFuXzg/zfs-vmware-perf/zfs_best_practices.pdf) to that web page. And here are some points from that article:
...
There is also an extensive list in an 'Solaris Internals' page called "[ZFS Best Practices Guide](https://googledrive.com/host/0B4vYKT_-8g4IWE9kS2hMMmFuXzg/zfs-vmware-perf/zfs_best_practices.pdf)".
