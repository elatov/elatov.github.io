...
Nothing complicated. I did some research and I actually found a very good website which talked about best practices for ZFS, here is a [link](https://seacloud.cc/d/480b5e8fcd/files/?p=/zfs-vmware-perf/zfs_best_practices.pdf&raw=1) to that web page. And here are some points from that article:
...
There is also an extensive list in an 'Solaris Internals' page called "[ZFS Best Practices Guide](https://seacloud.cc/d/480b5e8fcd/files/?p=/zfs-vmware-perf/zfs_best_practices.pdf&raw=1)".
