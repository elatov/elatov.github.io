...
In the above picture, Flex Fabric Interconnect is our Virtual Connect Interconnect Module. Flex Fabric is an extension of the Virtual Connect Module. From "[HP BladeSystem c-Class architecture](https://seacloud.cc/d/480b5e8fcd/files/?p=/hp_virtual_connect_nlb_disconnect/HP_BladeSystem_c-Class_architecture.pdf&raw=1)":
