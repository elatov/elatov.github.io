...
The most confusing one might be the thin vmdk and this article [Implementing EMC Symmetrix Virtual Provisioning with VMware vShpere](https://seacloud.cc/d/480b5e8fcd/files/?p=/thin-thin-symm/h2529vmwareesxsvrwsymmetrixwp.pdf&raw=1). The article has good description why the above is expected:
