...
<p class="wp-flattr-button">
  <a class="FlattrButton" style="display:none;" href="http://virtuallyhyper.com/2012/10/cant-run-websense-as-a-vm-on-esx-with-hp-virtualconnect/" title=" Can&#8217;t Run WebSense as a VM on ESX(i) Host with HP VirtualConnect" rev="flattr;uid:virtuallyhyper;language:en_GB;category:text;tags:HP VirtualConnect,Mirrored Traffic,Promiscuous Mode,SPAN Port,VLAN 4095,WebSense,blog;button:compact;">We were trying to setup a VM to run WebSense on it, but we couldn&#8217;t get all the traffic to reach the VM. Websense is a content filtering software, but...</a>
</p>