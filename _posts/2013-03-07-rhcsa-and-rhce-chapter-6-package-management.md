...
>
>
> When invoked this way, **rpmbuild** will read the .spec file and go through in order the stages listed below. Names beginning with % are predefined macros (see the next table down). [<img class="alignnone size-full wp-image-6169" alt="rpmbuild stages RHCSA and RHCE Chapter 6 Package Management" src="http://virtuallyhyper.com/wp-content/uploads/2013/02/rpmbuild_stages.png" width="1056" height="330" title="RHCSA and RHCE Chapter 6 Package Management" />](http://virtuallyhyper.com/wp-content/uploads/2013/02/rpmbuild_stages.png)
