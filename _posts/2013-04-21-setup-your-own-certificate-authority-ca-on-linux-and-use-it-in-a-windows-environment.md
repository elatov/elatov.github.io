...
You can check out examples from "[CA.pl - friendlier interface for OpenSSL certificate programs](https://www.openssl.org/docs/man1.0.1/apps/CA.pl.html) on how to use the Perl script; here is a very high level overview:
