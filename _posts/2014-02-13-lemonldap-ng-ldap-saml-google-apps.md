...
For some reason the [ld-run-path](https://blogs.oracle.com/ali/avoiding-ldlibrarypath) wasn't setting appropriately, and upon loading the **Lasso** perl module it would fail with the following message:
